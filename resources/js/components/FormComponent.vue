        ...
        <div
          ...
          <div class="bg-primary h-full  mx-auto">
            <div class="p-4">
              ...
              <p class="mt-8 mb-4 "> <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 mr-2 stroke-accent-second animate-pulse inline-flex">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="section-form-wrapper flex-1  sm:flex-1 xl:max-w-[800px]  ">
          <div class="container mx-auto">
            <form  @submit.prevent="submitForm()"
              class="form grid h-full grid-rows-[repeat(3,auto)] bg-primary box-shadow-primary p-4 gap-y-4 sm:py-9  " method="post" action="/">
              ...
              <div class="text-center relative z-10  border-t border-blue-100 ">
                <div class="" role="status" >
                  <svg aria-hidden="true"
                    class="inline w-4 h-4 ml-2 text-gray-200 animate-spin dark:text-gray-600 "
