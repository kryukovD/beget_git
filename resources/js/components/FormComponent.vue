...
<template>
  <section class="section-form text-white relative sm:border-b-[1px] sm:border-solid sm:border-white md:mb-24"
    id="formBlock">
    <div class="container mx-auto flex flex-wrap  justify-between">
      <div
        class="min-h-[158px] w-full  bg-blue-700  sm:w-full  sm:right-0 sm:top-4 sm:z-10 sm:order-2 md:w-full lg:w-[500px] md:h-[500px] xl:w-[600px] xl:h-[600px]">
        <div class="container mx-auto">
          <div class="p-4">
            <span class="block font-fair font-bold text-xl mb-0.5 md:text-2xl">Напиши мне
            </span>
            <p>Отвечу вам в ближайшее время!</p>
            <p class="mt-4 mb-4 d-flex animate-pulse"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                class="w-7 h-7 mb-1 stroke-orange-300 inline-flex">
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
              </svg>
              Готов ответить по любому вопросу.</p>
            <p class="mt-8 mb-2 animate-pulse"> <span><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                  viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 stroke-orange-300">
                  <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <div class="section-form-wrapper flex-1  sm:flex-1 xl:max-w-[800px]">
        <div class="container mx-auto">
          <form @submit.prevent="submitForm()" class="form grid grid-rows-[repeat(3,auto)]  p-4 gap-y-4 sm:py-[60px]  "
            method="post" action="/">
            <div class="section-form-input-wrap bg-white h-[48px] relative xl:h-[60px]">
              ...
              <input :class="{ 'border-pink-600': v$.form.name.$errors.length > 0 }"
                class="w-full h-full  rounded  text-black bg-[transparent] " v-model="form.name" type="text" name="name"
                placeholder="Имя">
            </div>
            ...
            <div class="section-form-input-wrap bg-white h-[48px]  relative xl:h-[60px]">
              ...
              <input :class="{ 'border-pink-600': v$.form.name.$errors.length > 0 }"
                class="w-full h-full rounded  text-black bg-[transparent] " v-model="form.email" type="text" name="email"
                placeholder="Email">
            </div>
            ...
            <div class="section-form-textarea  bg-white relative ">
              ...
              <textarea :class="{ 'border-pink-600': v$.form.name.$errors.length > 0 }" rows="5"
                class="w-full  pt-[17px] rounded  text-black bg-[transparent] " v-model="form.message" name="message"
                placeholder="Сообщение"></textarea>
            </div>
            <button ref="submitForm" class="shadow-xl bg-purple-600 p-2  relative z-10 rounded-sm 
