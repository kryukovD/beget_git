  ...
  <section class="section-technologies px-4 pt-6  md:mt-0 relative  ">
    <div class="container mx-auto sm:mb-4 xl:relative ">
      ...
      <div class="flex justify-between gap-4">
        ...
        <div class="arrows gap-4 flex ">
          <div
            class="arrow-left inline-flex cursor-pointer box-shadow-theme p-1 h-min transition delay-150 duration-300 ease-in-out hover:bg-gray-200"
            ref="prev"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-6 sm:size-6 xl:size-7 stroke-m-color">
              <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 15.75 3 12m0 0 3.75-3.75M3 12h18">
              </path>
            </svg></div>
          <div
            class="arrow-right inline-flex cursor-pointer box-shadow-theme p-1 h-min swiper-button-disabled transition delay-150 duration-300 ease-in-out hover:bg-gray-200"
            ref="next"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-6 sm:size-6 xl:size-7 stroke-m-color">
    ...
    <div class="container justify-between mx-auto xl:relative flex gap-8 flex-wrap lg:flex-nowrap  pb-10">
      <div class="w-full sm:order-2  lg:w-[auto]">
        <div class="min-h-[158px] w-full  text-m-color box-shadow-primary   sm:w-full md:w-full  sm:z-10  xl:right-0 ">
      ...
      <div class="w-full  lg:max-w-[400px]  xl:max-w-[50%]  order-[-1] ">
        ...
        <div class=" slider-technologies sm:mb-[30px]  relative">
          ...
          <swiper :modules="modules" :navigation="{
            ...
            :breakpoints="{ 0: { slidesPerView: 1 }, 460: { slidesPerView: 1.5, spaceBetween: '15' }, 640: { centeredSlides: false, slidesPerView: 3, spaceBetween: '15' }, 1024: { slidesPerView: 1, spaceBetween: '30' }, 1280: { slidesPerView: 2, spaceBetween: '30' } }"
            @swiper="onSwiper" @slideChange="onSlideChange">


            <swiper-slide v-for="(technology, key) of filterItems" :key="key" class="relative ">
              <div class="slilder-technologies__item  aspect-[1/1] overflow-hidden mx-auto  sm:m-0 sm:relative ">
                <img class=" mt-auto w-[100%] h-[100%] object-contain" :src="apiUrl + technology.srcImage"
                  :alt="'Технология' + ' ' + technology.name" />
                <span
