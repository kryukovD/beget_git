    ...
    <section class="section-technologies px-4 pt-6  md:mt-0 relative  ">
        <div class="container mx-auto sm:mb-4 xl:relative ">
          ...
          <span v-for="(item, i) of stack" :key="i" @click="filterTech(item.name), (active = i + 1)"
                ...
                <div class="arrows gap-4 flex flex-shrink-0">
                    <div
        ...
        <div class="container justify-between mx-auto xl:relative flex gap-8 flex-wrap lg:flex-nowrap  pb-10">
            <div class="w-full sm:order-2  lg:w-[auto]">
                <div
                    class="min-h-[158px] w-full  text-m-color box-shadow-primary   sm:w-full md:w-full  sm:z-10  xl:right-0 ">
                        ...
                        <div class="p-4 ">
                            <div class="">
                                <p class="mt-4 d-flex  ">
                                    ...
                                    Напишу вам сайт с использованием новых технологий в сфере WEB.
                                </p>
                            </div>
                            <div>
                                <p class="mt-8 ">
                                    ...
                                    <span>Профессиональные навыки:</span></p>
                                <ul class="mt-4 pl-4 ">
